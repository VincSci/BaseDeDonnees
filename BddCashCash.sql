...
--
-- Hôte : 127.0.0.1:3306
-- Généré le : Dim 08 mai 2022 à 13:36
...
DELIMITER $$
CREATE TRIGGER `after_insert_client` AFTER INSERT ON `client` FOR EACH ROW insert into modifclient                 values (null, CURDATE())
$$
DELIMITER ;
DROP TRIGGER IF EXISTS `after_update_client`;
DELIMITER $$
CREATE TRIGGER `after_update_client` AFTER UPDATE ON `client` FOR EACH ROW insert into modifclient               values (null, CURDATE())
$$
DELIMITER ;
...
(1, 'dupontj', 'dDqlBY5m1P06', 'gest', 1),
(2, 'dupondj', '3mTP97wQ8pBp', 'gest', 2),
(3, 'michelj', 'truc984gA5NfBdFy', 'tech', 3),
(4, 'paulj', 'oOfCm41PF02c', 'tech', 4),
(5, 'lucj', 'N10XzgfjM15W', 'tech', 5),
(6, 'pierrej', '1hpFxv8MUB51', 'tech', 6);
...
(1, '2020-11-20', '2022-11-20', 1, 'Type A'),
(2, '2020-10-18', '2022-10-18', 2, 'Type B'),
(3, '2020-09-16', '2022-09-16', 3, 'Type A'),
(4, '2020-08-14', '2022-08-14', 4, 'Type B'),
(5, '2020-07-12', '2022-07-12', 5, 'Type A');
...
(3, '18-05-2019', '14:30:00', '15:00:00', 'Non Realiser', 3, 5),
...
--
DROP TRIGGER IF EXISTS `after_insert_intervention`;
DELIMITER $$
CREATE TRIGGER `after_insert_intervention` AFTER INSERT ON `intervention` FOR EACH ROW insert into modifinter                 values (null, CURDATE())
$$
DELIMITER ;
DROP TRIGGER IF EXISTS `after_update_intervention`;
DELIMITER $$
CREATE TRIGGER `after_update_intervention` AFTER UPDATE ON `intervention` FOR EACH ROW insert into modifclient                 values (null, CURDATE())
$$
DELIMITER ;
...
(111, '2021-01-14', '2021-01-15', 25, 'Bureau Comptable', 'B1265', 1, 1),
(112, '2021-02-17', '2021-02-18', 25, 'Bureau Comptable', 'B1265', 2, 2),
(113, '2021-03-20', '2021-03-21', 25, 'Bureau Comptable', 'B1265', 3, 3),
(114, '2021-04-23', '2021-04-24', 25, 'Bureau Comptable', 'B1265', 4, 4),
(115, '2021-05-26', '2021-05-27', 25, 'Bureau Comptable', 'B1265', 5, 5),
(211, '2021-01-14', '2021-01-15', 95, 'Bureau Comptable', 'C2156', 1, 1),
(212, '2021-02-17', '2021-02-18', 95, 'Bureau Comptable', 'C2156', 2, 2),
(213, '2021-03-20', '2021-03-21', 95, 'Bureau Comptable', 'C2156', 3, 3),
(214, '2021-04-23', '2021-04-24', 95, 'Bureau Comptable', 'C2156', 4, 4),
(215, '2021-05-26', '2021-05-27', 95, 'Bureau Comptable', 'C2156', 5, 5),
(311, '2021-01-14', '2021-01-15', 150, 'Bureau Comptable', 'A3478', 1, 1),
(312, '2021-02-17', '2021-02-18', 150, 'Bureau Comptable', 'A3478', 2, 2),
(313, '2021-03-20', '2021-03-21', 150, 'Bureau Comptable', 'A3478', 3, 3),
(314, '2021-04-23', '2021-04-24', 150, 'Bureau Comptable', 'A3478', 4, 4),
(315, '2021-05-26', '2021-05-27', 150, 'Bureau Comptable', 'A3478', 5, 5);

-- --------------------------------------------------------

--
-- Structure de la table `modifclient`
--

DROP TABLE IF EXISTS `modifclient`;
CREATE TABLE IF NOT EXISTS `modifclient` (
...
--
-- Structure de la table `modifinter`
--

DROP TABLE IF EXISTS `modifinter`;
CREATE TABLE IF NOT EXISTS `modifinter` (
  `Num` int(11) NOT NULL AUTO_INCREMENT,
  `Date` date NOT NULL,
  PRIMARY KEY (`Num`)
